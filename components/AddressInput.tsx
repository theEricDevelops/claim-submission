...
export default function AddressInput({
  ...
  function handleFieldChange(field: 'street' | 'street2' | 'city' | 'state' | 'zip', val: string) {
    setUserConfirmed(false)
    setVerificationStatus('idle')
    const updated = { ...value, [field]: val }
    updated.formatted =
      `${updated.street}${updated.street2 ? `, ${updated.street2}` : ''}, ${updated.city}, ${updated.state} ${updated.zip}`.trim()
  ...
  if (manual) {
    return (
      <div className="field-group">
        ...
        <div className="field">
          <label htmlFor={`${instanceId}-street`}>Street Address</label>
          <input
            id={`${instanceId}-street`}
            value={value.street}
        ...
        <div className="field">
          <label htmlFor={`${instanceId}-street2`}>Apt / Suite</label>
          <input
            id={`${instanceId}-street2`}
            value={value.street2}
        ...
        <div className="field-row">
          <div className="field field-wide">
            <label htmlFor={`${instanceId}-city`}>City</label>
            <input
              id={`${instanceId}-city`}
              value={value.city}
          ...
          <div className="field field-narrow">
            <label htmlFor={`${instanceId}-state`}>State</label>
            <select
              id={`${instanceId}-state`}
              value={value.state}
          ...
          <div className="field field-narrow">
            <label htmlFor={`${instanceId}-zip`}>ZIP</label>
            <input
              id={`${instanceId}-zip`}
              value={value.zip}
  ...
  return (
    <div className="field-group">
      <div className="field address-autocomplete-field">
        <label htmlFor={`${instanceId}-autocomplete`}>
          {label}
          {required ? ' *' : ''}
        </label>
        <div className="address-input-wrapper">
          <input
            id={`${instanceId}-autocomplete`}
            type="text"
            value={inputText}
